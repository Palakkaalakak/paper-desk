        ...
        if key not in self._inflight:
            async def work():
                try:
                    ...
                    ttl = .25 if name == 'guns_bars' else 20 if name == 'guns_scan' else 60 if name == 'guns_verify' else 30 if name == 'guns_news' else 300 if name in ('search','chain','guns_article') else 1
