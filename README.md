...
- Added offline regressions for depth stream reuse, unchanged polling freshness, eviction, resets/reconnect generations, local credential authorization, atomic private file writes and UI key handling. Final browser acceptance for this pass is recorded below when completed.
